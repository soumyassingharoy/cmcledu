...
<!----header-end--->
      ...
      <main id="main">
            ...
            <div class="container">
               <div class="row">
                  ...
                  <div class="col-lg-6 mt-5">
                    <img src="assets/img/about.jpg" class="img-responsive img-rounded" alt="" >
         ...
         <!-- ======= Clients Section ======= -->
         <section id="clients" class="clients animate__animated animate__fadeIn">
            <div class="container">
               <div class="section-title">
                  <h2 class="text_sty">Facilities @ SPS</h2>
               </div>
         ...
         <!-- End Clients Section -->
         <!-- ======= more Section ======= -->
         <section class="more animate__animated animate__fadeIn">
            <div class="container">
               <div class="row">
